...
readonly git_commit_email=json2table@siakhooi.github.io
readonly git_commit_user=json2table
git_commit_message="json2table: Auto deploy [$(date)]"
readonly git_commit_message

set -e

debian_package_path=$(ls ./dist/siakhooi-json2table_*_amd64.deb)
